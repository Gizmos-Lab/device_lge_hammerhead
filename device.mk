...
PRODUCT_COPY_FILES += \
    ...
    device/lge/hammerhead/audio/audio_effects.xml:system/vendor/etc/audio_effects.xml \
    device/lge/hammerhead/audio_policy_configuration.xml:system/etc/audio_policy_configuration.xml \
